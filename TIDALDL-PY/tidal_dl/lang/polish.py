...
class LangPolish:
    ...
    CHANGE_ADD_EXPLICIT_TAG = (
        "Dodaj tag jednoznaczne do nazwy pliku('0'-Nie,'1'-Tak):"
    )
    CHANGE_ADD_HYPHEN = (
    ...
    CHANGE_USE_TRACK_NUM = (
        "Dodaj numer utworu przed nazwami plików('0'-Nie,'1'-Tak):"
    )
    CHANGE_CHECK_EXIST = (
    ...
    AUTH_NEXT_STEP = (
        "Przejdź do {} w ciągu następnych {} aby zakończyć konfigurację."
    )
