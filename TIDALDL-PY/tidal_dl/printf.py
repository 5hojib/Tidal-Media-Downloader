...
class Printf:
    ...
    def __gettable__(columns, rows):
        ...
        tb.field_names = [aigpy.cmd.green(item) for item in columns]
        tb.align = "l"
        for item in rows:
            tb.add_row(item)
        return tb
    ...
    @staticmethod
    def track(data: Track, stream: StreamUrl = None) -> None:
        tb = Printf.__gettable__(
    ...
    @staticmethod
    def video(data: Video, stream: VideoStreamUrl = None) -> None:
        tb = Printf.__gettable__(
    ...
    @staticmethod
    def artist(data: Artist, num) -> None:
        tb = Printf.__gettable__(
